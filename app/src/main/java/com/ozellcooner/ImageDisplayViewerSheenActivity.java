...
public class ImageDisplayViewerSheenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_image_display_sheen);
    ...
    public void hitServiceReport() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Url,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (TextUtils.isEmpty(response)) {
                                Toast.makeText(ImageDisplayViewerSheenActivity.this, "Error", Toast.LENGTH_SHORT).show();
                                return;
                            }
                            //parsing(response);
                            Gson gson = new Gson();
                            ...
                            ImageDisplayAdapter adapter = new ImageDisplayAdapter(ImageDisplayViewerSheenActivity.this, data);
                            recyclerView1.setAdapter(adapter);


                        } catch (Exception e) {
                            e.printStackTrace();
                            Toast.makeText(ImageDisplayViewerSheenActivity.this, "parsing Error", Toast.LENGTH_SHORT).show();
            ...
            public void onErrorResponse(VolleyError volleyError) {
                loaderDialog.dismiss();
                Toast.makeText(ImageDisplayViewerSheenActivity.this, "Error.. Check your Internet Connection", Toast.LENGTH_SHORT).show();
