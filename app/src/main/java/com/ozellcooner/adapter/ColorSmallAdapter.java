...
public class ColorSmallAdapter extends RecyclerView.Adapter<ColorSmallAdapter.MyViewHolder> {
    ...
    public ColorSmallAdapter(Context context, ArrayList<Datum> colorList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.color_small_item, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.shape.setCornerRadius(2);
