...
public class ColorCombinationTwoHorizontalAdapter extends RecyclerView.Adapter<ColorCombinationTwoHorizontalAdapter.MyViewHolder> {
    ...
    public ColorCombinationTwoHorizontalAdapter(Context context, ArrayList<Datum> colorList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.color_combination_item, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.shape.setCornerRadius(0);
...
//            holder.mainView.setLayoutParams(layoutParams);
           ...
           // holder.mainView.setBackgroundResource(R.drawable.round_color_black_bg);
            holder.mainView.setBackgroundColor(Color.BLACK);
        }else
        {
//            RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams)holder.mainView.getLayoutParams();
